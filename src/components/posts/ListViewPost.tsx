...
export const ListViewPost: React.FC<{ post: Post }> = ({ post }) => (
  <Card className="mb-4 bg-background border rounded-lg hover:shadow-md transition-shadow">
    <Link to={`/posts/${post.slug}`} state={{ id: post.id }} className="block">
      <div className="flex">
        {/* Thumbnail Image */}
        <div className="w-48 shrink-0">
          <img
            ...
            alt={post.title}
            className="h-32 rounded-l-lg rounded-t-none object-cover"
          />
        </div>
